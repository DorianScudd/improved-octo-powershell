## Was used to identify a bad KB install
function enable-privilege {
 param(
  ## The privilege to adjust. This set is taken from
  ## https://urldefense.com/v3/__http://msdn.microsoft.com/en-us/library/bb530716(VS.85).aspx__;!!ArFgGzGtaVk!kcydrU04x2WAmLKInou4sqhorqnMZ3Hd6LLFu8B7FghaQiJExLM_OhkOG_Kocu8U4A$ 
  [ValidateSet(
